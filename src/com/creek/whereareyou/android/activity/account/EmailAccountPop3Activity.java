 ...
 */
public class EmailAccountPop3Activity extends Activity {
    private static final String TAG = EmailAccountPop3Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle icicle) {
        ...
        testButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (fullProps != null) {
                    ...
                    Intent intent = new Intent(EmailAccountPop3Activity.this, CheckEmailResultActivity.class);
        ...
        advancedButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                final Bundle bundle = new Bundle();
                bundle.putSerializable(MAIL_PROPERTIES, fullProps);
                Intent intent = new Intent(EmailAccountPop3Activity.this, EmailAccountEditAdvancedActivity.class);
                intent.putExtras(bundle);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                try {
                    ...
                    showException(EmailAccountPop3Activity.this, ex);
                } catch (IOException ex) {
                    showException(EmailAccountPop3Activity.this, ex);
                } catch (CryptoException ex) {
                    showException(EmailAccountPop3Activity.this, ex);
