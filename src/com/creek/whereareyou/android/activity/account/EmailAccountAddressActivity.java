 ...
 */
public class EmailAccountAddressActivity extends Activity {
    private static final String TAG = EmailAccountAddressActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle icicle) {
        ...
        testButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (fullProps != null) {
                    ...
                    Intent intent = new Intent(EmailAccountAddressActivity.this, CheckEmailResultActivity.class);
        ...
        advancedButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                final Bundle bundle = new Bundle();
                bundle.putSerializable(MAIL_PROPERTIES, fullProps);
                Intent intent = new Intent(EmailAccountAddressActivity.this, EmailAccountEditAdvancedActivity.class);
                intent.putExtras(bundle);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                try {
                    ...
                    showException(EmailAccountAddressActivity.this, ex);
                } catch (IOException ex) {
                    showException(EmailAccountAddressActivity.this, ex);
                } catch (CryptoException ex) {
                    showException(EmailAccountAddressActivity.this, ex);
